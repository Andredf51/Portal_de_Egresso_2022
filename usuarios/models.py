...
class PerfilAluno(models.Model):
    ...
    trabalha_area = models.CharField(max_length=8, verbose_name='Trabalha na área', choices=TrabalhaArea_CHOICES, null=True)
    ifb_ajudou = models.CharField(max_length=8, verbose_name='O IFB ajudou a conseguir o seu emprego', choices=TrabalhaArea_CHOICES, null=True)
    grade_ifb = models.CharField(max_length=10, verbose_name='O que você achou da grade do IFB', null=True)
    curso_extra = models.CharField(max_length=10, verbose_name='Precisou fazer algum curso extra', choices=CursoExtra_CHOICES, null=True)
    qual_curso_extra = models.CharField(max_length=30, verbose_name='Qual o curso extra', null=True)
    opiniao_curso_ifb = models.CharField(max_length=100, verbose_name='O que você achou do curso do IFB', null=True)
    pode_melhorar = models.CharField(max_length=100, verbose_name='O que pode melhorar', null=True)
